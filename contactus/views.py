...
import json
import smtplib
from energysolar.settings import EMAIL_ADDRESS, EMAIL_PASSWORD, EMAIL_RECEIVER, LINKEDIN, LOCATION_ADDRESS, LOCATION_EMBED, LOCATION_LINK, FACEBOOK, TWITTER, YOUTUBE
